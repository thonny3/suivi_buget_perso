...
import { createComptes, getComptes } from '../../../../services/compteService';
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          >
            ...
            <option value="investissement">Compte  Bancaire</option>
            <option value="trading"> compte Mobile </option>
          </select>
        </div>
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
            ...
            <p className="text-2xl font-bold mt-2">{totalAccountBalance} {user.devise}</p>
          </div>
          ...
          <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-2xl p-6 text-white shadow-lg">
            ...
            <p className="text-2xl font-bold mt-2">
              {accounts.length > 0 ? (totalAccountBalance / accounts.length) : 0} {user.devise}
            </p>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {accounts.map((account) => (
                  ...
                  >
                    ...
                    <div className="mb-4">
                      <p className="text-3xl font-bold text-gray-900">{account.solde} {user.devise}</p>
