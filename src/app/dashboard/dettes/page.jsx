      ...
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="rounded-2xl p-4 sm:p-6 bg-white shadow-lg border border-gray-200">
            ...
            <p className="text-xl sm:text-2xl font-bold mt-2 text-gray-900 break-words break-all leading-tight">{totalInitial.toLocaleString('fr-FR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
          <div className="rounded-2xl p-4 sm:p-6 bg-white shadow-lg border border-gray-200">
            <h3 className="text-xs sm:text-sm font-medium text-gray-600">Montant restant total</h3>
            <p className="text-xl sm:text-2xl font-bold mt-2 text-gray-900 break-words break-all leading-tight">{totalRestant.toLocaleString('fr-FR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
          <div className="rounded-2xl p-4 sm:p-6 bg-white shadow-lg border border-gray-200">
            <h3 className="text-xs sm:text-sm font-medium text-gray-600">Nombre de dettes</h3>
            <p className="text-xl sm:text-2xl font-bold mt-2 text-gray-900 break-words break-all leading-tight">{items.length}</p>
          </div>
        </div>
