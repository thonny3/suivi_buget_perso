      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{t('dashboard.welcome')} {user.nom}, {t('dashboard.welcomeBack')}</p>
          </div>
        </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:block text-left">
                <p className="text-sm font-medium text-gray-700 group-hover:text-green-700">{user.nom}</p>
